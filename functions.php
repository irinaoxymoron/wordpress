...
function my_theme_load_resources() {
	...
	wp_enqueue_style( 'css', get_template_directory_uri() . '/css/style.css', array(), '0.1' );
	...
	wp_enqueue_script( 'mainjs', get_template_directory_uri() . '/js/js-main.js', array(), '0.1', true );
};
